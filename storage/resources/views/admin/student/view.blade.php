       ...
       @php elseif($row->type=='file'):  @endphp
        ...
        @php endif;  @endphp
         ...
         <div class="row" style="margin-bottom:  10px;">
            ...
            <div class="col-md-2 text-highlight-support5 "><strong>{{ __lang('session') }}:</strong></div>
            <div class="col-md-4">{{ htmlentities( $session->session_name) }}</div>
    
    
    
            <div class="col-md-2 text-highlight-support5 "><strong>{{ __lang('semester') }}</strong></div>
            <div class="col-md-4">{{ htmlentities( $semester->semester_name) }}</div>
        ...
        <div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                <tbody>
                @php foreach(\App\Student::find($id)->studentCourses as $session): @endphp
                    <tr>
