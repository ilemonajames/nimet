        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a class="nav-link" href="{{ route('admin.academic.session') }}"><i class="fas fa-book"></i><span><?= __lang('academic-session') ?></a></li>
                    <li><a class="nav-link" href="{{ route('admin.semester.index') }}"><i class="fas fa-book"></i><span><?= __lang('semester') ?></a></li>
                    <li><a class="nav-link" href="{{ route('admin.fees.index') }}"><i class="fas fa-wallet"></i><span><?= __lang('fees') ?></a></li>
                        <li><a class="nav-link" href="{{ route('admin.student.paymentHistory') }}"><i class="fas fa-wallet"></i><span><?= __lang('payment-history') ?></a></li>
                            @can('access-group','video')
                            <li style="display:none;" class="dropdown">
                                <a href="#" class="nav-link has-dropdown"><i class="fas fa-video"></i><span>{{ ('E-library') }}</span></a>
                                <ul class="dropdown-menu">
                                    @can('access','add_video')<li ><a class="nav-link" href="@route('admin.video.add')">{{ __lang('add-new') }}</a></li>@endcan
                                        @can('access','view_videos')<li ><a class="nav-link" href="@route('admin.video.index')">{{ ('All libraries') }}</a></li>@endcan
                                        @can('access','view_video_space')<li ><a class="nav-link" href="@route('admin.video.disk')">{{ ('Subscription packages') }}</a></li>@endcan
                                        @can('access','view_video_space')<li ><a class="nav-link" href="@route('admin.video.disk')">{{ ('All subscriptions') }}</a></li>@endcan
                                </ul>
                            </li>
                            @endcan
                        <li class="dropdown">
                    ...
                    <li class="dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fas fa-book"></i><span>{{ __lang('virtual-classes') }}</span></a>
                        <ul class="dropdown-menu">


                              
                              <li><a href="@route('admin.student.virtualclasses')" class="nav-link"><?= __lang('all-virtual-classes') ?></span></a></li>
                              <li><a class="nav-link" href="{{ route('admin.student.addvirtualclasses') }}"><?= __lang('add-virtual-class') ?></a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fas fa-video"></i><span>{{ ('E-library') }}</span></a>
                        <ul class="dropdown-menu">
                            @can('access','add_video')<li ><a class="nav-link" href="@route('admin.video.add')">{{ ('Add Files') }}</a></li>@endcan
                                @can('access','view_videos')<li ><a class="nav-link" href="@route('admin.video.index')">{{ ('All Files') }}</a></li>@endcan
                                @can('access','view_videos')<li ><a class="nav-link" href="@route('admin.video.packages')">{{ ('Subscription Packages') }}</a></li>@endcan
                                @can('access','view_videos')<li ><a class="nav-link" href="@route('admin.video.subscriptions')">{{ ('All Subscriptions') }}</a></li>@endcan
                   ...
                   @can('access-group','discussions')
                    ...
                    <li class="dropdown">
                        ...
                        @can('access-group','tests')
                        <li class="dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-check-circle"></i><span>{{ __lang('exams') }}</span></a>
                            <ul class="dropdown-menu">
                                @can('access','view_tests')<li ><a class="nav-link" href="@route('admin.exam.add')">{{ __lang('add-exam') }}</a></li>@endcan
                                @can('access','add_test')<li ><a class="nav-link" href="@route('admin.exam.index')">{{ __lang('all-exams') }}</a></li>@endcan
                            </ul>
                        </li>
                            @endcan
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                               ...
                               @can('access','edit_registration_field')<li ><a class="nav-link" href="@route('admin.setting.fields')">{{ __lang('custom-student-fields') }}</a></li>@endcan
                                    ...
                                    @can('access','view_payment_methods')<li style="display:none;"><a class="nav-link" href="@route('admin.payment-gateways')">{{ __lang('payment-methods') }}</a></li>@endcan

                                    @can('access','view_coupons')<li style="display:none;"><a class="nav-link" href="@route('admin.payment.coupons')">{{ __lang('coupons') }}</a></li>@endcan
                                    @can('access','manage_currencies')<li style="display:none;"><a class="nav-link" href="@route('admin.setting.currencies')">{{ __lang('currencies') }}</a></li>@endcan
                                    ...
                                    @can('access','view_test_grades')<li ><a class="nav-link" href="@route('admin.setting.testgrades')">{{ __lang('test-grades') }}</a></li>@endcan
                                    @can('access','view_test_grades')<li ><a class="nav-link" href="@route('admin.setting.examgrades')">{{ __lang('exam-grades') }}</a></li>@endcan
