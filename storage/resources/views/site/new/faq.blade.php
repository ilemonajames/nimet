...
.cd-faq__trigger:hover, .cd-faq__trigger:active{
  color: #111;
}
.cd-faq__category:hover, .cd-faq__category:active{
  color: #fff;
}
  </style>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-between">
          <div class="col-md-12">
            ...
            <script src="assets/assets/js/util.js"></script> <!-- util functions included in the CodyHouse framework -->
