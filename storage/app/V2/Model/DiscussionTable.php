...
class DiscussionTable extends BaseTable {
    ...
    public function getDiscussRecords($paginated=false,$replied=null)
    {
        if(GLOBAL_ACCESS){
            ...
            $select->join($this->getPrefix().'discussions',$this->getPrefix().'admin_discussion.discussion_id=discussions.id',['student_id','subject','question','created_at','replied','course_id','lecture_id','admin'])
