...
class SettingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //$session = AcademicSession::orderBy('id','desc')->get();
...
//            $files->copyOrMove('public/usermedia',$userPath,'','move');
    ...
    public function examgrades(Request $request){
        ...
        $this->data['grades'] = ExamGrade::orderBy('grade','asc')->get();
        $this->data['pageTitle'] = __lang('Grades');
        return view('admin.setting.examgrades',$this->data);
    }
    ...
    public function addexamgrade(Request $request){
        $form = $this->getTestGradeForm();
        ...
        if(request()->isMethod('post')){
            ...
            $form->setData($formData);
            if($form->isValid()){
                ExamGrade::create($form->getData());
                session()->flash('flash_message',__lang('Grade created'));
                return adminRedirect(['controller'=>'setting','action'=>'examgrades']);
            }
            else{
                $this->data['message'] = $this->getFormErrors($form);
            }
        ...
        $this->data['form'] = $form;
        $this->data['pageTitle'] = __lang('Add Exam Grade');

        return view('admin.setting.examgradeform',$this->data);
    }
    ...
    public function editexamgrade(Request $request,$id){
        $form = $this->getTestGradeForm();
        $testGrade = ExamGrade::find($id);
        if(request()->isMethod('post')){
            $formData = request()->all();
            $form->setData($formData);
            if($form->isValid()){
        ...
        $this->data['form'] = $form;
        $this->data['pageTitle'] = __lang('Edit Exam Grade').': '.$testGrade->grade;
    ...
    public function deleteexamgrade(Request $request,$id){
