...
Route::get('/testt', 'Auth\RegisterController@confirm');
Route::any('aptitude/index/{id}','Student\TestController@frontindex')->name('aptitude.index');
    Route::any('aptitude/taketest/{id}/{myid}/','Student\TestController@fronttaketest')->name('aptitude.taketest');
    Route::any('aptitude/processtest/{id}','Student\TestController@frontprocesstest')->name('aptitude.processtest');
    Route::any('aptitude/starttest/{id}','Student\TestController@frontstarttest')->name('aptitude.starttest');
    Route::any('aptitude/result/{id}','Student\TestController@frontresult')->name('aptitude.result');
    Route::any('aptitude/testresults/{id}/{myid}/','Student\TestController@fronttestresults')->name('aptitude.testresults');
    Route::any('aptitude/reportcard/{id}','Student\TestController@frontreportcard')->name('aptitude.reportcard');
    Route::any('aptitude/statement','Student\TestController@frontstatement')->name('aptitude.statement');
...
/*    Route::any('setting/roles','SettingController@roles')->name('setting.roles');
    ...
    Route::any('setting/examgrades','SettingController@examgrades')->name('setting.examgrades');
    Route::any('setting/addexamgrade','SettingController@addexamgrade')->name('setting.addexamgrade');
    Route::any('setting/editexamgrade/{id}','SettingController@editexamgrade')->name('setting.editexamgrade');
    Route::any('setting/deleteexamgrade/{id}','SettingController@deleteexamgrade')->name('setting.deleteexamgrade');
    ...
    Route::any('student/virtualclasses','StudentController@virtualclasses')->name('student.virtualclasses');
    Route::any('student/addvirtualclasses','StudentController@addvirtualclasses')->name('student.addvirtualclasses');
    Route::any('student/startclass/{id}','StudentController@startclass')->name('student.startclass');

    Route::any('academic/session','AcademicSessionController@session')->name('academic.session');
    Route::any('academic/addsession','AcademicSessionController@addsession')->name('academic.addsession');
    Route::any('academic/editsession/{id}','AcademicSessionController@editsession')->name('academic.editsession');
    Route::any('academic/deletesession/{id}','AcademicSessionController@deletesession')->name('academic.deletesession');
    Route::any('academic/defaultsession/{id}','AcademicSessionController@defaultsession')->name('academic.defaultsession');

    Route::any('semester/index','SemesterController@semester')->name('semester.index');
    Route::any('semester/addsemester','SemesterController@addsemester')->name('semester.addsemester');
    Route::any('semester/editsemester/{id}','SemesterController@editsemester')->name('semester.editsemester');
    Route::any('semester/deletesemester/{id}','SemesterController@deletesemester')->name('semester.deletesemester');

    Route::any('fees/index','FeesController@fees')->name('fees.index');
    Route::any('fees/addfee','FeesController@addfee')->name('fees.addfee');
    Route::any('fees/editfee/{id}','FeesController@editfee')->name('fees.editfee');
    Route::any('fees/deletefee/{id}','FeesController@deletefee')->name('fees.deletefee');

    Route::any('student/index','StudentController@index')->name('student.index');
    Route::any('student/paymentHistory','StudentController@paymentHistory')->name('student.paymentHistory');
    ...
    Route::any('student/removestudentolevelresult/{id}','StudentController@removestudentolevelresult')->name('student.removestudentolevelresult');
    ...
    Route::any('exam/index','ExamController@index')->name('exam.index');
    Route::any('exam/add','ExamController@add')->name('exam.add');
    Route::any('exam/edit/{id}','ExamController@edit')->name('exam.edit');
    Route::any('exam/delete/{id}','ExamController@delete')->name('exam.delete');
    Route::any('exam/questions/{id}','ExamController@questions')->name('exam.questions');
    Route::any('exam/addquestion/{id}','ExamController@addquestion')->name('exam.addquestion');
    Route::any('exam/editquestion/{id}','ExamController@editquestion')->name('exam.editquestion');
    Route::any('exam/addoptions','ExamController@addoptions')->name('exam.addoptions');
    Route::any('exam/editoption/{id}','ExamController@editoption')->name('exam.editoption');
    Route::any('exam/deletequestion/{id}','ExamController@deletequestion')->name('exam.deletequestion');
    Route::any('exam/deleteoption/{id}','ExamController@deleteoption')->name('exam.deleteoption');
    Route::any('exam/duplicate/{id}','ExamController@duplicate')->name('exam.duplicate');
    Route::any('exam/results/{id}','ExamController@results')->name('exam.results');
    Route::any('exam/deleteresult/{id}','ExamController@deleteresult')->name('exam.deleteresult');
    Route::any('exam/examresult/{id}','ExamController@examresult')->name('exam.examresult');
    Route::any('exam/exportresult/{id}','ExamController@exportresult')->name('exam.exportresult');
    Route::any('exam/sessions/{id}','ExamController@sessions')->name('exam.sessions');
    Route::any('exam/addsession/{id}','ExamController@addsession')->name('exam.addsession');
    Route::any('exam/editsession/{id}','ExamController@editsession')->name('exam.editsession');
    Route::any('exam/deletesession/{id}','ExamController@deletesession')->name('exam.deletesession');
    Route::any('exam/importquestions/{id}','ExamController@importquestions')->name('exam.importquestions');
    Route::any('exam/exportquestions/{id}','ExamController@exportquestions')->name('exam.exportquestions');
    ...
    Route::any('video/subscriptions','VideoController@subscriptions')->name('video.subscriptions');

    Route::any('video/packages','VideoController@packages')->name('video.packages');
    Route::any('video/addpackage','VideoController@addpackage')->name('video.addpackage');
    Route::any('video/editpackage/{id}','VideoController@editpackage')->name('video.editpackage');
    Route::any('video/deletepackage/{id}','VideoController@deletepackage')->name('video.deletepackage');
    ...
    Route::any('elibrary/index','ElibraryController@index')->name('elibrary.index');
    Route::any('elibrary/add','ElibraryController@add')->name('elibrary.add');
    Route::any('elibrary/delete/{id}','ElibraryController@delete')->name('elibrary.delete');
    Route::any('elibrary/removeimage/{id}','ElibraryController@removeimage')->name('elibrary.removeimage');
    Route::any('elibrary/play/{id}','ElibraryController@play')->name('elibrary.play');
    Route::any('elibrary/serve/{id}','ElibraryController@serve')->name('elibrary.serve');
    Route::any('elibrary/disk','ElibraryController@disk')->name('elibrary.disk');
    Route::any('elibrary/edit/{id}','ElibraryController@edit')->name('elibrary.edit');
...
Route::group(['middleware'=>['auth','student'],'prefix' => 'student', 'as' => 'student.','namespace'=>'Student'],function() {
    ...
    Route::any('student/myfees','StudentController@myfees')->name('student.myfees');
    Route::any('student/subscribe','StudentController@mysubscriptions')->name('student.subscribe');
    Route::any('student/elibrary','StudentController@elibrary')->name('student.elibrary');
    Route::any('student/play/{id}','StudentController@play')->name('student.play');
    Route::any('student/serve/{id}','StudentController@serve')->name('student.serve');
    ...
    Route::any('student/removeolevelresult','StudentController@removeolevelresult')->name('student.removeolevelresult');
    ...
    Route::any('student/invoices','StudentController@invoices')->name('student.invoices');
    Route::any('student/receipt/{id}','StudentController@receipt')->name('student.receipt');
    ...
    Route::any('exam/index','ExamController@index')->name('exam.index');
    Route::any('exam/takeexam/{id}','ExamController@takeexam')->name('exam.takeexam');
    Route::any('exam/processexam/{id}','ExamController@processexam')->name('exam.processexam');
    Route::any('exam/startexam/{id}','ExamController@startexam')->name('exam.startexam');
    Route::any('exam/result/{id}','ExamController@result')->name('exam.result');
    Route::any('exam/examresults/{id}','ExamController@examresults')->name('exam.examresults');
    Route::any('exam/reportcard/{id}','ExamController@reportcard')->name('exam.reportcard');
    Route::any('exam/statement','ExamController@statement')->name('exam.statement');
...
Route::group(['namespace'=>'Site','middleware'=>'site'],function(){
    ...
    Route::get('/our-instructors','HomeController@ourInstructors')->name('ourInstructors');
    ...
    Route::any('course/single/{id}','HomeController@singleCourse')->name('course.single');
