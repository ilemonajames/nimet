...
class FeesController extends Controller
{
    ...
    public function addfee(Request $request){
        ...
        if (request()->isMethod('post')) {
            ...
            if ($form->isValid()) {
                ...
                session()->flash('flash_message',__lang('fee-created'));
                return adminRedirect(array('controller'=>'fees','action'=>'index'));
        ...
        $output['form'] = $form;
        $output['pageTitle']= __lang('add-fee');
        $output['action']='addfee';
        $output['id']=null;
    ...
    public function editfee(Request $request,$id){
        ...
        $output['form'] = $form;
        $output['id'] = $id;
        $output['pageTitle']= __lang('edit-fee');
        $output['row']= $row;
        $output['action']='editfee';

        $viewModel = viewModel('admin',__CLASS__,'addfee',$output);
        return $viewModel ;
    }
