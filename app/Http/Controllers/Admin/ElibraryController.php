...
class ElibraryController extends Controller
{
    ...
    private $videoDir = 'medialibrary';
    private $videoPath = 'medialibrary';
    //create video list
    public function index(Request $request) {
        // TODO Auto-generated NewssController::index(Request $request) default action
        $table = new ElibraryTable();
    ...
    public function add(Request $request){
        ...
        if(request()->isMethod('post')){
            ...
            if (!is_dir($targetDir)){
                ...
                if (file_exists('medialibrary/.htaccess')){
                    file_put_contents($this->videoPath.'/.htaccess',file_get_contents('medialibrary/.htaccess'));
                }
