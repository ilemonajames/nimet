...
{
    protected $fillable = ['name','credit_unit','course_code','admin_id','enabled','start_date','end_date','enrollment_closes','capacity','payment_required','fee','description','venue','type','picture','enable_discussion','enable_chat','enforce_order','effort','length','short_description','introduction','enable_forum','enforce_capacity', 'session_id','semester_id'];
