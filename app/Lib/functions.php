...
function getCourseCategories(){
    $CourseCategory = \App\CourseCategory::where(array('enabled'=>1,'parent_id'=>null))->get();
    if($CourseCategory){
...
function selfURL() {
	...
	return $protocol."://".$_SERVER['SERVER_NAME'].':8000'.$_SERVER['REQUEST_URI'];
}
...
function sendEmail($recipientEmail,$subject,$message,$from=null,$cc=null,$attachments=null){
    ...
    $mail = new PHPMailer(true);
        ...
        //$mail->SMTPDebug = 2;
        $mail->isSMTP();
        $mail->Host       =  'mail.comelynation.com';
        $mail->SMTPAuth   = true;
        $mail->Username   =  'mailer@comelynation.com';
        $mail->Password   =  'zs0&b!Bml_V$';
