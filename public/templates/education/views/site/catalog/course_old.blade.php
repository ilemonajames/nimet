        ...
        <div class="col-md-8">
            <div class="card course-info profile-widget mt-0">
                ...
                <div class="card-footer text-center">
                    ...
                    <a class="btn btn-primary mb-2  btn-lg" href="{{  route('cart.add',['course'=>$course->id])  }}"><i class="fa fa-cart-plus"></i> {{  __lang('enroll')  }}</a> &nbsp;&nbsp;  &nbsp;&nbsp;
                        ...
                        <div class="card author-box card-primary">
                            <div class="card-body">
                                <div class="author-box-left">
                                    ...
                                    <a href="#" class="btn btn-primary mt-3"  data-toggle="modal" data-target="#contactModal{{  $instructor->admin_id  }}" ><i class="fa fa-envelope"></i> {{  __lang('about')  }}</a>
                                @section('footer')
                                    @parent
                                    <!-- Modal -->
