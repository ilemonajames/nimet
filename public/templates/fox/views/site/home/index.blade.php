            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 ftco-animate">
                    <div class="blog-entry">
                        <a href="{{ route('blog.post',['blogPost'=>$post->id]) }}" class="block-20 d-flex align-items-end" @if(!empty($post->cover_photo)) style="background-image: url('{{ asset($post->cover_photo) }}');" @endif >
                        ...
                        <div class="text bg-white p-4">
                            ...
                            <div class="d-flex align-items-center mt-4">
                                <p class="mb-0"><a href="{{ route('blog.post',['blogPost'=>$post->id]) }}" class="btn btn-primary">{{ __lang('read-more') }} <span class="ion-ios-arrow-round-forward"></span></a></p>
