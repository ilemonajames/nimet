    ...
    <div class="row">
        <div class="col-md-{{ (setting('menu_show_certificates')==1 || setting('menu_show_tests')==1) ? '5':'10' }}">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <div ><h4><i class="fa fa-school"></i> {{ " ".$session_name. " Session - ".$semester_name }}</h4></div>
                </div>
            </div>
            <div class="card card-primary">
                <div class="card-header">
                ...
                @if($default == $session && $payment_status == 1)
                <div class="card-body">
                    <div class="summary">
        ...
        <div class="col-md-5">
            ...
            <div class="card card-info">
                <div class="card-header">
                    ...
                    <div class="card-header-action"><a class="btn btn-primary" href="{{ route('student.test.index') }}">{{ __lang('view-all') }}</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="summary">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h4><i class="fas fa-check-circle"></i> {{ __lang('exams') }}</h4>
                    <div class="card-header-action"><a class="btn btn-primary" href="{{ route('student.exam.index') }}">{{ __lang('view-all') }}</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="summary">
                        <div class="summary-item">
                            <h6>{{ __lang('your-recent-performance') }}</h6>
                            <ul class="list-unstyled list-unstyled-border">
                                @foreach($student->studentExams()->orderBy('id','desc')->limit(5)->get() as $examResult)
                                <li class="media">

                                    <div class="media-body">
                                        <div class="media-right">{{ round($examResult->score) }}%</div>
                                        <div class="media-title"><a href="{{ route('student.exam.takeexam',['id'=>$examResult->exam_id]) }}">{{ $examResult->exam->name }}</a></div>
                                        <div class="text-muted text-small">{{ __lang('taken-on') }}    {{ \Illuminate\Support\Carbon::parse($examResult->created_at)->format('d m Y') }}</div>
                                    </div>
                                </li>
                                @endforeach
        ...
        <div class="col-md-2">
            <ul class="list-group">
                ...
                <li class="list-group-item"><a href="{{ route('student.student.myfees') }}"><i class="fas fa-wallet"></i> {{ setting('label_my_sessions',__lang('fee-payments')) }}</a></li>
