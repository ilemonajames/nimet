                ...
                <div class="tab-pane fade" id="download3" role="tabpanel" aria-labelledby="download-tab3">
                    ...
                    <table class="table table-hover">
                        ...
                        <td class="text-right">
                            ...
                            <a href="{{  $this->url('application/download-list',array('id'=>$download->download_id)) }}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" data-original-title="{{  __lang('View files')  }}"><i class="fa fa-eye"></i> {{  __lang('View files')  }}</a>
                            <a href="{{  $this->url('application/download-all',array('id'=>$download->download_id)) }}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" data-original-title="{{  __lang('Download All')  }}"><i class="fa fa-download"></i> {{  __lang('Download All')  }}</a>
                            @php  else: @endphp
