				...
				<div class="card">
					...
					<div class="card-body">
						...
						<table class="table table-hover">
							...
							<tbody>
                            @php $i =1; foreach($paginator as $row):  @endphp
								<tr>
									<td><span class="label label-success">{{ $i++ }}</span></td>
                                    <td>
									...
									<td >
                                        ...
                                        <a href="#" style="display:none;" onclick="openModal('{{__lang('enroll')}}','{{ adminUrl(array('controller'=>'student','action'=>'enroll','id'=>$row->id)) }}')"  data-toggle="tooltip" data-placement="top" data-original-title="Enroll"   title="{{ __lang('Enroll') }}" type="button" class="btn btn-xs btn-primary btn-equal"  ><i class="fa fa-plus"></i></a>
