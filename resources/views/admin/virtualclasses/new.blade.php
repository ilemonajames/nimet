...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="sessionform" class="form-horizontal" role="form" method="post" action="{{ adminUrl(array('controller'=>'student','action'=>$action.'virtualclasses','id'=>$id,'type'=>$type)) }}">
            @csrf
                    ...
                    <ul class="wizard_steps">
                        <li>
                            ...
                            <span class="step_descr">
                                              {{ __lang('info') }}<br />
                                              <small>{{ __lang('basic-vclass-data') }}</small>
                                          </span>
                            </a>
                        </li>
                        <li>
                            ...
                            <span class="step_descr">
                                              {{ __lang('options') }}<br />
                                              <small>{{ __lang('vclass-options') }}</small>
                                          </span>
                            </a>
                        </li>
                        <li>
                    ...
                    <div id="step-1">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div >
                                        <label for="password1" class="control-label"><span class="required">*</span>{{ __lang('vclass-name') }}</label>
                                    </div>
                                    <div >
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div >
                                        <label for="password1" class="control-label">{{ __lang('vclass-description') }}</label>
                                    </div>
                                    <div >
                    ...
                    <div id="step-2">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div >
                                        <label for="password1" class="control-label">{{ __lang('change-default-setting') }}</label>
                                    </div>
                                    <div >
                                        
                                        <div>
                                            <select type="select" name="change_default_setting" class="form-control" data-options="required:true" required="required">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div >
                                        <label for="password1" class="control-label">{{ __lang('join-before-host') }}</label>
                                    </div>
                                    <div >
                                         <div>
                                            <select type="select" name="join_before_host" class="form-control" data-options="required:true" required="required">
                                                <option value="false">False</option>
                                                <option value="true">True</option>
                                            </select>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div >
                                        <label for="password1" class="control-label">{{ __lang('host-video') }}</label>
                                    </div>
                                    <div >
                                        
                                        <div>
                                            <select type="select" name="host_video" class="form-control" data-options="required:true" required="required">
                                                <option value="false">False</option>
                                                <option value="true">True</option>
                                            </select>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div >
                                        <label for="enable_discussion" class="control-label">{{ __lang('participant-video') }}</label>
                                    </div>
                                    <div >
                                        <div>
                                            <select type="select" name="participant_video" class="form-control" data-options="required:true" required="required">
                                                <option value="false">False</option>
                                                <option value="true">True</option>
                                            </select>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div >
                                        <label for="enable_discussion" class="control-label">{{ __lang('participant-mic-mute') }}</label>
                                    </div>
                                    <div >
                                        <div>
                                            <select type="select" name="participant_mic_mute" class="form-control" data-options="required:true" required="required">
                                                <option value="false">False</option>
                                                <option value="true">True</option>
                                            </select>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div >
                                        <label for="enable_discussion" class="control-label">{{ __lang('waiting-room') }}</label>
                                    </div>
                                    <div >
                                        <div>
                                            <select type="select" name="waiting_room" class="form-control" data-options="required:true" required="required">
                                                <option value="false">False</option>
                                                <option value="true">True</option>
                                            </select>
                                        </div>
                    ...
                    <div id="step-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div >
                                        <label for="password1" class="control-label"><span class="required">*</span>{{ __lang('vclass-start-time') }}</label>
                                    </div>
                                    <div >
                            ...
                            <div class="col-md-6">
                                <div class="form-group" style="display: none;">
                                    <div >
                                        <label for="password1" class="control-label">{{ __lang('vclass-end-date') }}</label>
                                    </div>
                                    <div >
                                ...
                                <div class="form-group">
                                    <div >
                                        <label for="password1" class="control-label"><span class="required">*</span>{{ __lang('student-limit') }}</label>
                                    </div>
                                    <div>
                                        <input name="student_limit" type="number" class="form-control" required="required">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div >
                                        <label for="password1" class="control-label"><span class="required">*</span>{{ __lang('duration') }}</label>
                                    </div>
                                    <div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div >
                                        <label for="password1" class="control-label"><span class="required">*</span>{{ __lang('password') }}</label>
                                    </div>
                                    <div>
