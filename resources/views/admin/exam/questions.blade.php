                    ...
                    @php foreach($paginator as $row):  @endphp
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ adminUrl(array('controller'=>'exam','action'=>'editquestion','id'=>$row->id)) }}" class="btn btn-xs btn-primary btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="{{ __lang('edit-questions-options') }}"><i class="fa fa-edit"></i></a>

                                 <a onclick="return confirm('{{__lang('delete-confirm')}}')" href="{{ adminUrl(array('controller'=>'exam','action'=>'deletequestion','id'=>$row->id)) }}"  class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="{{__lang('delete')}}"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="questionform" method="post" action="{{ adminUrl(['controller'=>'exam','action'=>'addquestion','id'=>$id]) }}">
@csrf
    ...
    <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form enctype="multipart/form-data" id="importform" method="post" action="{{ adminUrl(['controller'=>'exam','action'=>'importquestions','id'=>$id]) }}">
                @csrf
                    <div class="modal-body">
                        <p>
                            {!! __lang('import-exam-questions-help',['link'=>basePath().'/client/data/exam_question_sample.csv']) !!}
                        </p>
                        <div class="form-group">
