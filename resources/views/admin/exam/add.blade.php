    ...
    <div >
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ adminUrl(array('controller'=>'exam','action'=>$action,'id'=>$id)) }}">
                    @csrf
                ...
                <div class="form-group">
                    ...
                    <p class="help-block">{{ __lang('exam-passmark-help') }}</p>
                ...
                <div class="form-group">
                    ...
                    <p class="help-block">{{ __lang('exam-private-help') }}</p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <p class="help-block">{{ __lang('exam-show-result-help') }}</p>
                </div>
