...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form method="post" action="{{ adminUrl(array('controller'=>'exam','action'=>'editquestion','id'=>$id)) }}">
        @csrf
            ...
            @php foreach($rowset as $row):  @endphp
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" onclick="openModal('{{__lang('edit-option')}}','{{ adminUrl(array('controller'=>'exam','action'=>'editoption','id'=>$row->id)) }}');"  class="btn btn-xs btn-primary btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="{{__lang('edit')}}"><i class="fa fa-edit"></i></a>

                        <a onclick="return confirm('{{__lang('delete-confirm')}}')" href="{{ adminUrl(array('controller'=>'exam','action'=>'deleteoption','id'=>$row->id)) }}"  class="btn btn-xs btn-primary btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="{{__lang('delete')}}"><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="questionform" method="post" action="{{ adminUrl(['controller'=>'exam','action'=>'addoptions','id'=>$id]) }}">
                    @csrf
