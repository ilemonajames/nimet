                ...
                <div id="step-1">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <div>
                                    <label for="password1" class="control-label"><span class="required">*</span>{{ __lang('course-code') }}</label>
                                </div>
                                <div>
                                    {{ formElement($form->get('course_code')) }}
                                    <p class="help-block">{{ formElementErrors($form->get('course_code')) }}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <div>
                                    <label for="password1" class="control-label">{{ __lang('credit-unit') }}</label>
                                </div>
                                <div>
                                    {{ formElement($form->get('credit_unit')) }}
                                    <p class="help-block">{{ formElementErrors($form->get('credit_unit')) }}</p>
                                </div>
                            </div>
                        </div>
