        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            ...
            <div class="nav-collapse">
                ...
                <ul class="navbar-nav">
                    ...
                    <li style="display: none;" class="nav-item"><a href="{{ route('sessions') }}" class="nav-link">{{ __lang('upcoming-sessions') }}</a></li>
                    @endif
                </ul>
            </div>
            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a style="display: none;" href="@route('student.student.billing')" class="dropdown-item has-icon">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-border">
                            ...
                            @endif
                            <li class="nav-item"><a href="{{ route('student.student.subscribe') }}" class="nav-link">{{ ('Subscribe') }}</a></li>
                            <li class="nav-item"><a href="{{ route('student.student.elibrary') }}" class="nav-link">{{ ('E-Library') }}</a></li>
                           </ul>
                    </li>
                    @endif
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-border">
                            <li class="nav-item"><a href="{{ route('student.exam.index') }}" class="nav-link">{{ __lang('browse-exams') }}</a></li>
                            <li class="nav-item"><a href="{{ route('student.exam.statement') }}" class="nav-link">{{ __lang('statement-of-result') }}</a></li>
                        </ul>
                    </li>
                    @endif
                </ul>
