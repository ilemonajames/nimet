...
<head>
  ...
  <meta name="description" content="NIMET - Online learning portal">
  <meta name="keywords" content="Education,NIMET,instructor,lms,online,instructor,courses,tutor,e learning">
  <meta name="author" content="Pyrich Group Nigeria">

  <title>Nigerian Meterological Agency (NIMET) - Online learning portal</title>
...
<link href="{{ asset('css/style.css?v1.0.0') }}" rel="stylesheet" />
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-xl-6 col-lg-7 col-md-12">
                   <div class="d-sm-flex justify-content-center justify-content-lg-end">
                        ...
                        <div class="header-btn text-center text-lg-end">
                           <a href="{{ route('register') }}"> <i class="fa fa-user-alt"></i> Apply For Admission</a>
                        </div>
                   </div>
                </div>
            </div>
