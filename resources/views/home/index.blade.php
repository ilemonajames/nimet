        ...
        <div class="carousel-inner">
            <div class="item slider1 active">
                ...
                <div class="carousel-caption slider-con">
                    ...
                    <a href="{{ url('/courses') }}" class="bann-btn-1 bg">All Courses</a><a href="{{ url('/register') }}" class="bann-btn-2">Apply For Admission</a>
                </div>
            </div>
            <div class="item item1">
                <img src="slider/2.jpg" alt="">
                <div class="carousel-caption slider-con">
                    <h3 style="color: black">Enjoy a Personalized <span class="color">Learning Experience</span> </h3>
                    <p style="color: black">Advance your career in business analytics, statistics, economic management and more.</p>
                    <a href="{{ url('/about') }}" class="bann-btn-1 bg">About Us</a><a href="{{ url('/our-instructors') }}" class="bann-btn-3">Instructors</a>
                </div>
            </div>
            {{-- <div class="item">
